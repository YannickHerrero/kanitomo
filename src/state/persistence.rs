...
pub struct AppState {
    ...
    /// Best 2048 scores (highest first)
    #[serde(default)]
    pub game_2048_best_scores: Vec<u32>,
    /// Best VSRG scores (highest first)
    #[serde(default)]
    pub vsrg_best_scores: Vec<u32>,
}
...
impl Default for AppState {
    fn default() -> Self {
        Self {
            ...
            game_2048_best_scores: Vec::new(),
            vsrg_best_scores: Vec::new(),
        }
    }
}
